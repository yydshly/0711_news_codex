    ...
    class FakePipeline:
        def run(self, **kwargs):
            ...
            return PipelineResult(
                ...
                newsworthy_item_count=4,
                non_newsworthy_item_count=1,
                newsworthiness_reasons={"no_event_action": 1},
                pair_direct_merge_count=2,
                pair_model_merge_count=1,
                pair_separate_count=3,
                pair_cache_hit_count=4,
                ambiguous_pairs_checked=5,
                model_pair_fallback_count=2,
                events_with_official_root=2,
                events_with_one_professional_root=1,
                events_with_two_professional_roots=1,
                confirmed_event_count=3,
                pair_model_error_counts={"no_api_key": 1},
