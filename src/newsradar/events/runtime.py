        ...
        if lease.operation_type == OperationType.EVENT_PIPELINE.value:
            ...
            return OperationResult(
                result_summary={
                    ...
                    "newsworthy_item_count": result.newsworthy_item_count,
                    "non_newsworthy_item_count": result.non_newsworthy_item_count,
                    "newsworthiness_reasons": result.newsworthiness_reasons,
                    "pair_direct_merge_count": result.pair_direct_merge_count,
